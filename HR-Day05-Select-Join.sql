...
/*
Natural Join 생성
    두 개의 테이블에서 데이터 유형과 이름을 일치시키는 열을 기반으로 자동으로 테이블을 조인할 수 있습니다.
*/
...
*/
SELECT  worker.last_name emp, manger.last_name mgr 
FROM employees JOIN employees manager
ON(worker.manager_id  = manager.employee_id);

/*
비동일결합
    Nonequijoin은 등호외의 다른 위치를 포함하는 조인 조건입니다.
